...
print('Lately I have been feeling unsure of myself as a person & an artist')
print(sc_tf_idf.classify(pm))

pm = process_message('Extreme sadness, lack of energy, hopelessness')
print('Extreme sadness, lack of energy, hopelessness')
print(sc_tf_idf.classify(pm))

pm = process_message('Hi hello depression and anxiety are the worst')
print('Hi hello depression and anxiety are the worst')
print(sc_tf_idf.classify(pm))

pm = process_message('I am officially done with @kanyewest')
print('I am officially done with @kanyewest')
print(sc_tf_idf.classify(pm))
...
print('My depression will not let me work out')
print(sc_tf_idf.classify(pm))
...
print('Loving how me and my lovely partner is talking about what we want.')
print(sc_tf_idf.classify(pm))
...
print('Very rewarding when a patient hugs you and tells you they feel great after changing the diet and daily habits')
print(sc_tf_idf.classify(pm))

pm = process_message('Happy Thursday everyone. Thought today was Wednesday so super happy tomorrow is Friday yayyyyy')
print('Happy Thursday everyone. Thought today was Wednesday so super happy tomorrow is Friday yayyyyy')
print(sc_tf_idf.classify(pm))

pm = process_message('It’s the little things that make me smile. Got our new car today and this arrived with it')
print('It’s the little things that make me smile. Got our new car today and this arrived with it')
print(sc_tf_idf.classify(pm))
